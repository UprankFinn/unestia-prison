...
public class ItemBuilder {
    ...
    public ItemBuilder setCrate(String key, String localizedName) {

        ItemMeta itemMeta = this.itemStack.getItemMeta();
        CrateType crateType = CrateType.valueOf(key);

        itemMeta.setLocalizedName(localizedName);
        itemMeta.setDisplayName(crateType.getDisplayName());
        itemMeta.addEnchant(crateType.getEnchantmentList(), 1, true);
